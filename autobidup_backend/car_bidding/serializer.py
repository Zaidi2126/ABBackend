...
class CarSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=bidding_car
        fields=["name", "username", "phone_no", "chassis_no", "engine_no", "automatic_generated_bid_id", "year", "make", "model", "mileage", "modified", "car_type", "car_location", "miniform_approved", "engine_type", "room_id", "starting_bid", "room_id_alloted", "engine_capacity", "transmission", "assembly", "ad_title", "ad_description", "bid_date", "bid_time", "airbags", "alloy_wheels", "immoblizer", "ac", "cool_box", "folding_seats", "power_door_locks", "antibrakingsystem", "images"]
...
class RoomSerializer(serializers.ModelSerializer):
    class Meta:
        model=bidding_room
        fields=["room_id", "automatic_generated_bid_id", "year", "make", "model", "mileage", "modified", "car_type", "engine_type", "engine_capacity", "transmission", "assembly", "ad_title", "bid_datetime_left", "start_date", "start_time", "starting_bid", "increase_bid", "higest_bid", "highest_bidder", "bid_winner", "current_bid"]

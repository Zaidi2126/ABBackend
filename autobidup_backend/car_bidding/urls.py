...
from .views import get_bidding_records_roomid,RoomIdAllotedAPIView,RecordDetailsAPIusername,RecordDetailsAPI,increase_bid,exit_bidding_room,enter_bidding_room,allot_bidding_room,difference_of_time,AcceptMiniForm,RegisterMiniForm,RegisterMainForm,show_all_bidding_cars,show_bidding_rooms,search_all_bidding_cars,search_bidding_room
...
urlpatterns = [
    ...
    path('search_bidding_room',search_bidding_room.as_view()),
    ...
    path('cars_with_room_id',RoomIdAllotedAPIView.as_view()),
    path('get_bidding_records_roomid',get_bidding_records_roomid),
